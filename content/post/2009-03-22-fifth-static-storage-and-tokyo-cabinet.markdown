...
url: /2009/03/22/fifth-static-storage-and-tokyo-cabinet/
wordpress_id: 197
...
{{< highlight clj >}} (declare *db*){{< / highlight >}}
...
{{< highlight clj >}}(defmacro use [filename & body]{{< / highlight >}}
...
{{< highlight clj >}}`(with-open [hdb# (HDB.)]{{< / highlight >}}
...
{{< highlight clj >}}(.open hdb# ~filename (bit-or HDB/OWRITER HDB/OCREAT)){{< / highlight >}}
...
{{< highlight clj >}}(binding [*db* hdb#]{{< / highlight >}}
...
{{< highlight clj >}}(do ~@body)))){{< / highlight >}}
